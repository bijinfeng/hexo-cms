...
export class WebPluginConfigStore
  extends WebBackedPluginStore<PluginConfigStoreValue>
...
export class DesktopPluginConfigStore
  extends DesktopBackedPluginStore<PluginConfigStoreValue>
  implements PluginConfigStore
{
  constructor() {
    super({

# Hexo CMS 插件系统设计文档（历史参考）

> **版本**: 1.0.0  
> **最后更新**: 2026-04-30  
> **状态**: 历史参考，不作为当前实施准绳

> 当前插件系统以拆分后的 PRD 与技术方案为准:
>
> - [插件系统 PRD](./plugin/PRD_PLUGIN_SYSTEM.md)
> - [插件系统技术方案](./plugin/TECHNICAL_DESIGN_PLUGIN_SYSTEM.md)
>
> 本文保留早期完整设想，用于背景参考。实现时应优先遵循“可信内置插件、声明式 UI、受控权限、暂不开放第三方未审核代码”的新范围。
